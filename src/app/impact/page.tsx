...
export const metadata: Metadata = {
  title: "Access & Impact",
  description:
    "See the barriers facing Central Texas youth percussionists and how NOVA's academy can create continued access, development, and belonging.",
};
    ...
    <>
      ...
      <section className="proof-section">
        ...
        <div className="proof-copy">
          ...
          <p>
            ...
            The academy translates that affirmed need into a more accessible,
      ...
      <section className="impact-model-section">
        ...
        <div className="impact-model-copy">
          <p className="eyebrow">The NOVA response</p>
          <h2>Remove the barrier. Keep the standard.</h2>
          <p>
            NOVA&apos;s academy is designed to widen the entry point while preserving
