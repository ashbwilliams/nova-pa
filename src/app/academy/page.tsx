...
export const metadata: Metadata = {
  title: "The Academy",
  description:
    "Discover NOVA's noncompetitive, off-season marching percussion academy for young musicians in Central Texas.",
};
    ...
    <>
      ...
      <section className="academy-intro">
        ...
        <div className="academy-intro-copy">
          <p>
            The academy is designed for young percussionists who want to continue
      ...
      <section className="not-competition-section">
        ...
        <div className="not-competition-copy">
          ...
          <p>
            Noncompetitive does not mean casual. The academy will hold students to
      ...
      <section className="who-section">
        <div className="who-copy">
          <p className="eyebrow">Who the academy is for</p>
          <h2>Young musicians ready for their next season of growth.</h2>
          <p>
            The academy is being developed for Central Texas youth with marching
      ...
      <CtaBand
        eyebrow="Make the academy possible"
        title="Students are ready to keep learning."
        body="Your support can help secure instruments, rehearsal space, instruction, and student assistance for the academy's first season."
        primaryHref="/support"
