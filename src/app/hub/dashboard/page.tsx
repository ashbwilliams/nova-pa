    ...
    <div className="hub-shell">
      ...
      <div className="hub-main">
        ...
        <section className="hub-section" id="program">
          <div className="hub-section-heading">
            <div>
              <p className="eyebrow">Academy controls</p>
          ...
          <form action={saveProgramDetails} className="hub-editor-form">
            ...
            <button className="hub-save-button" type="submit" disabled={!storageConfigured}>Publish academy details</button>
          </form>
        </section>
        ...
        <section className="hub-section" id="content">
          ...
          <form action={saveSiteContent} className="hub-editor-form">
            ...
            <div className="hub-form-grid">
              <label>Academy headline<input name="academyHeadline" defaultValue={content.academyHeadline} required maxLength={180} /></label>
              <label>Support headline<input name="supportHeadline" defaultValue={content.supportHeadline} required maxLength={180} /></label>
            </div>
            <label>Academy overview<textarea name="academyOverview" defaultValue={content.academyOverview} rows={4} required maxLength={700} /></label>
