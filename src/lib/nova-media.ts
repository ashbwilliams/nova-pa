...
export const mediaSlotDefinitions = [
  ...
  {
    key: "fellowship.hero",
    group: "Teaching Fellowship",
    label: "Page hero",
    description: "Opening image on the NOVA 8 Teaching Fellowship page.",
    aspectRatio: "Landscape",
    aspectRatioCss: "4 / 3",
    recommendedSize: "1800 × 1350 px",
    fallbackSrc: "/images/music-clinic.jpg",
    fallbackAlt: "A percussion educator working with young musicians in rehearsal",
    focalX: 50,
    focalY: 50,
  },
  {
    key: "partnerships.hero",
    group: "Partnership Opportunities",
    label: "Page hero",
    description: "Opening image on the Partnership Opportunities page.",
    aspectRatio: "Landscape",
    aspectRatioCss: "4 / 3",
    recommendedSize: "1800 × 1350 px",
    fallbackSrc: "/images/music-clinic.jpg",
    fallbackAlt: "Percussion educators and young musicians working together",
    focalX: 50,
    focalY: 50,
  },
  {
